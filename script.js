...
window.addEventListener('DOMContentLoaded', function () {
  ...
  miniSlider.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officerold', '.officer__card-item').render();
  var server = new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('form').render();
});
...
/*#__PURE__*/
function () {
  function Difference(newOfficer, oldOfficer, items) {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(officer, items, count) {
    ...
    value: function sendData() {
      ...
      this.forms.forEach(function (i) {
        i.addEventListener('submit', function (e) {
          ...
          i.parentNode.appendChild(_this.statusText);
          _this.statusText.style.cssText = "\n                    margin-top: 18px;\n                    font-size: 25px;\n                    color: #e05c91;\n                ";
          _this.statusText.textContent = _this.message.waiting;

          _this.postData('../../assets/question.php', formData).then(function (data) {
            _this.statusText.textContent = _this.message.succes;
          }).catch(function () {
            _this.statusText.textContent = _this.message.fail;
          }).finally(function () {
            setInterval(function () {
              i.reset();

              _this.statusText.remove();
            }, 4000);
          });
        });
      });
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (i) {
        i.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            _this.overlay.style.display = 'flex';
          } else {
            var path = i.getAttribute('data-url');
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, autoplay, animate, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, autoplay, animate, activeClass));
  }
